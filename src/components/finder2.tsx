...
const handleNachrichtClick = () => {
  ...
  const resetForm = () => {
          ...
          {!showTischOptions && !showStuhlOptions && !showLampeOptions && !showAufbewahrungOptions && (
            <>
              ...
              >
                  ...
                  <svg
                    id="_x30_1_Shapes"
                    style={{ fill: 'currentColor', enableBackground: 'new 0 0 200 200', minHeight: '50px', minWidth: '50px' }}
                    version="1.1"
                    viewBox="0 0 200 200"
                    xmlSpace="preserve"
              ...
              >
                  ...
                  <svg
                    id="_x30_1_Shapes"
                    style={{ fill: 'currentColor', enableBackground: 'new 0 0 48 48', minHeight: '50px', minWidth: '50px' }}
                    version="1.1"
                    viewBox="0 0 200 200"
                    xmlSpace="preserve"
                    xmlns="http://www.w3.org/2000/svg"
              ...
              >
                  ...
                  <svg
                    id="_x30_1_Shapes"
                    style={{ fill: 'currentColor', enableBackground: 'new 0 0 48 48', minHeight: '20px', minWidth: '20px' }}
                    version="1.1"
                    viewBox="0 0 200 200"
                    xmlSpace="preserve"
                    xmlns="http://www.w3.org/2000/svg"
              ...
              >
               <div className='p-2 md:p-5'>
                <div className='mt-2'>
                  <svg
                    id="_x30_1_Shapes"
                    style={{ fill: 'currentColor', enableBackground: 'new 0 0 48 48', margin:'auto', Height: '40px', Width: '40px' }}
          ...
          <p className="text-lg font-semibold mb:text-xl text-center mb-10 md:mb-16 xl:mb-28 ">Welchen Stil hast du dir vorgestellt?</p>
            ...
            <button
              ...
              >
                  ...
                  <svg
                    id="_x30_1_Shapes"
                    style={{ fill: 'currentColor', enableBackground: 'new 0 0 10000 10000', minHeight: '50px', minWidth: '50px' }}
                    className='p-1'
                    version="1.1"
            ...
            <div className='z-0 h-10'>
              ...
              >
                ...
                <div > Weiter</div>
                  <svg
                    id="_x30_1_Shapes"
                    style={{ fill: 'currentColor', enableBackground: 'new 0 0 64 64'}}
    ...
    {currentStep === 5 && (
      ...
      <div class="label">
        <span class="label-text hidden md:block">Hier kannst du deine Nachricht nochmal kontrollieren oder uns eine freie Nachricht schreiben</span>
      </div>
